...
|:---|:-----|:-----|:-------|:-----|:-----|:------|
| S1-01 | [US] 为ConfigNode添加dict标准方法 | 方案已决策 | P1 | 2 |  |  |
...
| S1-04 | [BUG] config.progress 变化触发配置自动备份 | 方案已决策 | P2 | 2 |  |  |

**Sprint 总点数**：12

**Issue 统计**：共 4 个 | 待办 0 | 方案已选择 0 | 方案已决策 2 | 方案设计中 0 | 实施中 0 | 进行中 0 | 设计完成 0 | 待验收 2 | 已完成 0 | 已取消 0 | 推迟 0 | 已关闭 0
