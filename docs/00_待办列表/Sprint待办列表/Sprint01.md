...
|:---|:-----|:-----|:-------|:-----|:-----|:------|
| S1-01 | [US] 为ConfigNode添加dict标准方法 | 待验收 | P1 | 2 |  |  |
...
| S1-05 | [BUG] config.progress 变化时 config.yaml 正常保存且不触发备份 | 设计完成 | P2 | 2 |  | S1-05-design-v1 |

**Sprint 总点数**：14

**Issue 统计**：共 5 个 | 待办 0 | 方案已选择 0 | 方案已决策 0 | 方案设计中 0 | 实施中 0 | 进行中 0 |
设计完成 1 | 待验收 4 | 已完成 0 | 已取消 0 | 推迟 0 | 已关闭 0
